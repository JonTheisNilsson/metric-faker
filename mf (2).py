...
def job(user, password, metric_id):
    def next_metric_fact(mf):
        ...
        vol = 0.20 # very high. 'Normal' = 0.02
...
# begins module gives easy console args. "if __name__" not necessary.
@begin.start(auto_convert=True)
def main(user, password, metric_id, minutes: 'Minutes between uploads'=60):
